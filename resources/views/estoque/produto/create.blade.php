                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="codigo" class="form-control" required value="{{ old('codigo') }}" placeholder="Código do produto...">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="estoque" class="form-control" required value="{{ old('estoque') }}" placeholder="Estoque do produto...">
                        </div>
                    </div>
